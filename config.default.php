...
$conf["apiurl"] = "https://stpauls.clickedu.eu/ws/app_clickedu_query.php"; // URL del Web Service de ClickEdu
...
); // Lista de materias (llave es id_cgap, y valor es el nombre de la materia)
